		  ...
		  <Link href="#">
		    ...
		    <div className="px-4 py-3 w-72 dark:bg-gray-900">
		      ...
		      <div className="flex items-center">
		        <p className="text-lg font-semibold text-black cursor-auto my-3 dark:text-white">$149</p>
		        <del>
		          <p className="text-sm text-gray-500 cursor-auto ml-2">$199</p>
		        </del>
